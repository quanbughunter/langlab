...
const PINYIN_ZH = {
  ...
  /* 21 thanh mẫu (声母). vi = cách đọc mô tả cho người Việt; hz/py/exvi = chữ ví dụ */
  initials: [
    { p:'b',  grp:'Môi',       vi:'Âm /p/ KHÔNG bật hơi. Gần «p» trong «pin» hơn là «b» tiếng Việt — hai môi khép rồi mở, không đẩy hơi ra.', py:'bā',   hz:'八', exvi:'tám' },
    { p:'p',  grp:'Môi',       vi:'Như b nhưng BẬT HƠI mạnh. Để tờ giấy trước miệng phải thấy giấy bay.', py:'pǎo',  hz:'跑', exvi:'chạy' },
    { p:'m',  grp:'Môi',       vi:'Đúng như «m» tiếng Việt.', py:'mā',   hz:'妈', exvi:'mẹ' },
    { p:'f',  grp:'Môi',       vi:'Như «ph» tiếng Việt: răng trên chạm môi dưới rồi xát hơi.', py:'fàn',  hz:'饭', exvi:'cơm' },
    { p:'d',  grp:'Đầu lưỡi',  vi:'Âm /t/ KHÔNG bật hơi — gần «t» tiếng Việt, tuyệt đối không đọc thành «đ».', py:'dà',   hz:'大', exvi:'to' },
    { p:'t',  grp:'Đầu lưỡi',  vi:'Như d nhưng BẬT HƠI — gần «th» tiếng Việt.', py:'tā',   hz:'他', exvi:'anh ấy' },
    { p:'n',  grp:'Đầu lưỡi',  vi:'Đúng như «n» tiếng Việt.', py:'nǐ',   hz:'你', exvi:'bạn' },
    { p:'l',  grp:'Đầu lưỡi',  vi:'Đúng như «l» tiếng Việt.', py:'lái',  hz:'来', exvi:'đến' },
    { p:'g',  grp:'Gốc lưỡi',  vi:'Âm /k/ KHÔNG bật hơi — gần «c/k» tiếng Việt, gốc lưỡi chạm ngạc mềm.', py:'gāo',  hz:'高', exvi:'cao' },
    { p:'k',  grp:'Gốc lưỡi',  vi:'Như g nhưng BẬT HƠI mạnh — mạnh hơn «kh» tiếng Việt.', py:'kàn',  hz:'看', exvi:'xem' },
    { p:'h',  grp:'Gốc lưỡi',  vi:'Xát ở gốc lưỡi, thô và sâu hơn «h» tiếng Việt, nghe gần «kh».', py:'hǎo',  hz:'好', exvi:'tốt' },
    { p:'j',  grp:'Mặt lưỡi',  vi:'Đầu lưỡi hạ sau răng dưới, mặt lưỡi áp ngạc cứng. Gần «ch» nhưng mỏng và KHÔNG bật hơi.', py:'jiā',  hz:'家', exvi:'nhà' },
    { p:'q',  grp:'Mặt lưỡi',  vi:'Khẩu hình như j nhưng BẬT HƠI mạnh.', py:'qù',   hz:'去', exvi:'đi' },
    { p:'x',  grp:'Mặt lưỡi',  vi:'Khẩu hình như j nhưng xát liên tục — gần «x» tiếng Việt, mỏng hơn.', py:'xiè',  hz:'谢', exvi:'cảm ơn' },
    { p:'zh', grp:'Uốn lưỡi',  vi:'UỐN LƯỠI: đầu lưỡi cuộn lên chạm ngạc cứng. Gần «tr» giọng Nam, không bật hơi.', py:'zhōng',hz:'中', exvi:'giữa, Trung' },
    { p:'ch', grp:'Uốn lưỡi',  vi:'Như zh nhưng BẬT HƠI mạnh.', py:'chī',  hz:'吃', exvi:'ăn' },
    { p:'sh', grp:'Uốn lưỡi',  vi:'Uốn lưỡi rồi xát — gần «s» giọng Nam đọc nặng.', py:'shì',  hz:'是', exvi:'là' },
    { p:'r',  grp:'Uốn lưỡi',  vi:'Uốn lưỡi có rung nhẹ, nằm giữa «r» và «gi»; môi KHÔNG tròn.', py:'rén',  hz:'人', exvi:'người' },
    { p:'z',  grp:'Đầu lưỡi–răng', vi:'Đầu lưỡi chạm chân răng trên, bật ra thành «ts» — không bật hơi.', py:'zì',   hz:'字', exvi:'chữ' },
    { p:'c',  grp:'Đầu lưỡi–răng', vi:'Như z nhưng BẬT HƠI mạnh — «tsh».', py:'cài',  hz:'菜', exvi:'món ăn' },
    { p:'s',  grp:'Đầu lưỡi–răng', vi:'Như «x» tiếng Việt, đầu lưỡi gần răng trên, xát nhẹ.', py:'sān',  hz:'三', exvi:'ba' }
  ],
  /* 36 vận mẫu (韵母) xếp theo nhóm nguyên âm mở đầu */
  finals: [
    { p:'a',   grp:'Đơn',   vi:'«a» mở rộng miệng, rõ và dài.', py:'mā', hz:'妈', exvi:'mẹ' },
    { p:'o',   grp:'Đơn',   vi:'«ô» tròn môi; sau b p m f thực chất đọc gần «uô».', py:'mō', hz:'摸', exvi:'sờ' },
    { p:'e',   grp:'Đơn',   vi:'«ơ» lùi về sau, môi DẸT chứ không tròn.', py:'hē', hz:'喝', exvi:'uống' },
    { p:'i',   grp:'Đơn',   vi:'«i» căng. Nhưng sau zh ch sh r z c s thì đọc như «ư» ngắn, không phải «i».', py:'yī', hz:'一', exvi:'một' },
    { p:'u',   grp:'Đơn',   vi:'«u» tròn môi, đẩy môi ra trước.', py:'bù', hz:'不', exvi:'không' },
    { p:'ü',   grp:'Đơn',   vi:'«uy»: môi tròn như u nhưng lưỡi ở vị trí i. Giữ nguyên môi tròn suốt âm.', py:'nǚ', hz:'女', exvi:'nữ' },
    { p:'ai',  grp:'Đôi',   vi:'«ai», âm a rõ rồi lướt sang i.', py:'mǎi', hz:'买', exvi:'mua' },
    { p:'ei',  grp:'Đôi',   vi:'«ây» chứ không phải «ei» tách rời.', py:'měi', hz:'美', exvi:'đẹp' },
    { p:'ao',  grp:'Đôi',   vi:'«ao», kết thúc môi hơi tròn.', py:'hǎo', hz:'好', exvi:'tốt' },
    { p:'ou',  grp:'Đôi',   vi:'«âu» chứ không phải «ou».', py:'gǒu', hz:'狗', exvi:'con chó' },
    { p:'an',  grp:'Mũi',   vi:'«an», đầu lưỡi chạm chân răng khi khép.', py:'kàn', hz:'看', exvi:'xem' },
    { p:'en',  grp:'Mũi',   vi:'«ân» chứ không phải «en».', py:'hěn', hz:'很', exvi:'rất' },
    { p:'ang', grp:'Mũi',   vi:'«ang», khép bằng gốc lưỡi, âm vang hơn an.', py:'máng', hz:'忙', exvi:'bận' },
    { p:'eng', grp:'Mũi',   vi:'«âng» — so với en thì khép ở gốc lưỡi.', py:'lěng', hz:'冷', exvi:'lạnh' },
    { p:'ong', grp:'Mũi',   vi:'«ung» môi tròn; không đứng một mình, luôn có phụ âm đầu.', py:'zhōng', hz:'中', exvi:'giữa' },
    { p:'er',  grp:'Cong lưỡi', vi:'«ơ» rồi cong đầu lưỡi lên; luôn đứng một mình.', py:'èr', hz:'二', exvi:'hai' },
    { p:'ia',  grp:'Nhóm i', vi:'«i-a» đọc liền thành «ia». Không phụ âm đầu viết là ya.', py:'jiā', hz:'家', exvi:'nhà' },
    { p:'ie',  grp:'Nhóm i', vi:'«iê». Chữ e ở đây đọc «ê» chứ không phải «ơ».', py:'xiè', hz:'谢', exvi:'cảm ơn' },
    { p:'iao', grp:'Nhóm i', vi:'«i-ao» lướt nhanh, nghe gần «eo».', py:'xiǎo', hz:'小', exvi:'nhỏ' },
    { p:'iou', grp:'Nhóm i', vi:'Có phụ âm đầu thì VIẾT TẮT thành -iu: l + iou → liù. Nhưng vẫn đọc đủ ba âm.', py:'liù', hz:'六', exvi:'sáu' },
    { p:'ian', grp:'Nhóm i', vi:'Đọc gần «iên» chứ không phải «i-an».', py:'tiān', hz:'天', exvi:'trời' },
    { p:'in',  grp:'Nhóm i', vi:'«in», khép bằng đầu lưỡi.', py:'xīn', hz:'新', exvi:'mới' },
    { p:'iang',grp:'Nhóm i', vi:'«i-ang» liền một hơi.', py:'xiǎng', hz:'想', exvi:'muốn, nghĩ' },
    { p:'ing', grp:'Nhóm i', vi:'«ing», khép bằng gốc lưỡi.', py:'tīng', hz:'听', exvi:'nghe' },
    { p:'iong',grp:'Nhóm i', vi:'«i-ung» môi tròn; chỉ ghép với j q x.', py:'xiōng', hz:'兄', exvi:'anh trai' },
    { p:'ua',  grp:'Nhóm u', vi:'«oa». Không phụ âm đầu viết là wa.', py:'huà', hz:'话', exvi:'lời nói' },
    { p:'uo',  grp:'Nhóm u', vi:'«uô». Sau b p m f thì viết gọn thành -o (bo, po, mo, fo).', py:'guó', hz:'国', exvi:'nước, quốc' },
    { p:'uai', grp:'Nhóm u', vi:'«oai» đủ ba âm.', py:'kuài', hz:'快', exvi:'nhanh' },
    { p:'uei', grp:'Nhóm u', vi:'Có phụ âm đầu thì VIẾT TẮT thành -ui: h + uei → huì.', py:'huì', hz:'会', exvi:'biết, sẽ' },
    { p:'uan', grp:'Nhóm u', vi:'«oan».', py:'wǎn', hz:'晚', exvi:'muộn, tối' },
    { p:'uen', grp:'Nhóm u', vi:'Có phụ âm đầu thì VIẾT TẮT thành -un: g + uen → gùn. Đứng một mình là wen.', py:'wèn', hz:'问', exvi:'hỏi' },
    { p:'uang',grp:'Nhóm u', vi:'«oang».', py:'huáng', hz:'黄', exvi:'màu vàng' },
    { p:'ueng',grp:'Nhóm u', vi:'Chỉ tồn tại ở dạng KHÔNG có phụ âm đầu, viết là weng.', py:'wēng', hz:'翁', exvi:'ông lão' },
    { p:'üe',  grp:'Nhóm ü', vi:'«uê» với môi tròn kiểu ü. Sau j q x viết là ue (jue, que, xue).', py:'xué', hz:'学', exvi:'học' },
    { p:'üan', grp:'Nhóm ü', vi:'«uên» môi tròn. Sau j q x viết là uan (juan, quan, xuan).', py:'yuǎn', hz:'远', exvi:'xa' },
    { p:'ün',  grp:'Nhóm ü', vi:'«uyn» môi tròn. Sau j q x viết là un (jun, qun, xun).', py:'yùn', hz:'运', exvi:'vận, chuyển' }
  ],
  /* Bảng ghép hợp lệ: thanh mẫu → các vận mẫu ghép được ('' = âm tiết không có phụ âm đầu) */
  combos: {
    '':  'a o e ai ei ao ou an en ang eng er i ia ie iao iou ian in iang ing iong u ua uo uai uei uan uen uang ueng ü üe üan ün',
    b:   'a o ai ei ao an en ang eng i iao ie ian in ing u',
    p:   'a o ai ei ao ou an en ang eng i iao ie ian in ing u',
    m:   'a o e ai ei ao ou an en ang eng i iao ie iou ian in ing u',
    f:   'a o ei ou an en ang eng u',
    d:   'a e ai ei ao ou an ang eng ong i iao ie iou ian ing u uo uei uan uen',
    t:   'a e ai ao ou an ang eng ong i iao ie ian ing u uo uei uan uen',
    n:   'a e ai ei ao ou an en ang eng ong i iao ie iou ian in iang ing u uo uan ü üe',
    l:   'a e ai ei ao ou an ang eng ong i ia iao ie iou ian in iang ing u uo uan uen ü üe',
    g:   'a e ai ei ao ou an en ang eng ong u ua uo uai uei uan uen uang',
    k:   'a e ai ao ou an en ang eng ong u ua uo uai uei uan uen uang',
    h:   'a e ai ei ao ou an en ang eng ong u ua uo uai uei uan uen uang',
    j:   'i ia iao ie iou ian in iang ing iong ü üe üan ün',
    q:   'i ia iao ie iou ian in iang ing iong ü üe üan ün',
    x:   'i ia iao ie iou ian in iang ing iong ü üe üan ün',
    zh:  'a e i ai ei ao ou an en ang eng ong u ua uo uai uei uan uen uang',
    ch:  'a e i ai ao ou an en ang eng ong u uo uai uei uan uen uang',
    sh:  'a e i ai ei ao ou an en ang eng u ua uo uai uei uan uen uang',
    r:   'e i ao ou an en ang eng ong u uo uei uan uen',
    z:   'a e i ai ei ao ou an en ang eng ong u uo uei uan uen',
    c:   'a e i ai ao ou an en ang eng ong u uo uei uan uen',
    s:   'a e i ai ao ou an en ang eng ong u uo uei uan uen'
  },
  notes: [
