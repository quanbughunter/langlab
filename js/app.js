...
const TOPIK_TESTS = [
  {
    id:'topik1', badge:'TOPIK I', title:'Đề thi thử TOPIK I — Sơ cấp',
    official:'Đề thật: 100 phút · 70 câu (Nghe 30 + Đọc 40)', minutes:25,
    questions:[
      {k:'listen', a:'안녕하세요. 저는 베트남에서 왔어요.', q:'이 사람은 어느 나라 사람입니까?', o:['한국 사람','베트남 사람','중국 사람','일본 사람'], c:1, e:'“베트남에서 왔어요” = đến từ Việt Nam → người Việt Nam.'},
      {k:'listen', a:'저는 아침 일곱 시에 일어나요.', q:'이 사람은 몇 시에 일어납니까?', o:['여섯 시','일곱 시','여덟 시','아홉 시'], c:1, e:'일곱 시 = 7 giờ (giờ dùng số thuần Hàn).'},
      {k:'listen', a:'가: 뭐 드시겠어요? 나: 비빔밥 주세요.', q:'“나”는 무엇을 시킵니까?', o:['김밥','비빔밥','불고기','냉면'], c:1, e:'“비빔밥 주세요” = cho tôi cơm trộn.'},
      {k:'listen', a:'도서관은 은행 옆에 있어요.', q:'도서관은 어디에 있습니까?', o:['은행 옆','은행 앞','학교 뒤','시장 안'], c:0, e:'옆 = bên cạnh → cạnh ngân hàng.'},
      {k:'listen', a:'내일은 토요일이라서 학교에 안 가요.', q:'이 사람은 내일 학교에 갑니까?', o:['네, 갑니다','아니요, 안 갑니다','오전에만 갑니다','모릅니다'], c:1, e:'“안 가요” = không đi.'},
      {k:'listen', a:'가: 주말에 뭐 했어요? 나: 친구하고 영화를 봤어요.', q:'“나”는 주말에 무엇을 했습니까?', o:['공부했어요','영화를 봤어요','운동했어요','일했어요'], c:1, e:'영화를 보다 = xem phim (quá khứ 봤어요).'},
      {k:'listen', a:'저는 커피보다 차를 더 좋아해요.', q:'이 사람이 더 좋아하는 것은 무엇입니까?', o:['커피','차','물','우유'], c:1, e:'“커피보다 차를 더” = thích trà hơn cà phê.'},
      {k:'listen', a:'이 사과는 한 개에 천 원이에요.', q:'사과 한 개는 얼마입니까?', o:['백 원','천 원','오천 원','만 원'], c:1, e:'천 원 = 1000 won.'},
      {k:'read', p:'저는 학생입니다. 매일 학교에서 한국어를 공부합니다.', q:'이 사람은 무엇을 공부합니까?', o:['영어','중국어','한국어','일본어'], c:2, e:'“한국어를 공부합니다” = học tiếng Hàn.'},
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 저는 도서관___ 공부해요.', o:['에','에서','를','도'], c:1, e:'에서 = ở (nơi diễn ra hành động 공부하다).'},
      {k:'read', p:'지금은 오후 세 시입니다. 두 시간 후에 친구를 만납니다.', q:'몇 시에 친구를 만납니까?', o:['세 시','네 시','다섯 시','여섯 시'], c:2, e:'3 giờ + 2 tiếng = 5 giờ (다섯 시).'},
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 날씨가 추워서 코트를 ___.', o:['입어요','벗어요','먹어요','마셔요'], c:0, e:'Trời lạnh nên “mặc” áo khoác → 입어요.'},
      {k:'read', p:'가: 이거 얼마예요? 나: 삼천 원이에요.', q:'무엇을 하는 대화입니까?', o:['물건을 삽니다','길을 묻습니다','전화를 합니다','음식을 만듭니다'], c:0, e:'Hỏi giá “얼마예요?” → đang mua đồ.'},
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 저는 한국 음식을 좋아해요. ___ 김치는 조금 매워요.', o:['그리고','그런데','그래서','그러면'], c:1, e:'그런데 = nhưng, thể hiện ý trái ngược.'},
      {k:'read', p:'민수 씨는 요리를 잘합니다. 그래서 주말마다 가족에게 음식을 만들어 줍니다.', q:'민수 씨는 주말에 무엇을 합니까?', o:['요리합니다','청소합니다','공부합니다','운동합니다'], c:0, e:'“음식을 만들어 줍니다” = nấu ăn.'},
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 어제 친구___ 만났어요.', o:['을','를','에','에서'], c:1, e:'만나다 đi với 을/를; 친구 kết thúc nguyên âm → 를.'}
    ]
  },
  {
    id:'topik2', badge:'TOPIK II', title:'Đề thi thử TOPIK II — Trung/Cao cấp',
    official:'Đề thật: 180 phút · 104 câu (Nghe 50 + Viết 4 + Đọc 50)', minutes:30,
    questions:[
      {k:'listen', a:'가: 이번 주말에 등산 갈래요? 나: 미안해요. 주말에 아르바이트를 하기로 했어요.', q:'여자는 왜 등산을 갈 수 없습니까?', o:['몸이 아파서','아르바이트를 해서','날씨가 나빠서','약속을 잊어서'], c:1, e:'“아르바이트를 하기로 했어요” = đã hẹn làm thêm.'},
      ...
      {k:'listen', a:'이 영화는 슬프지만 정말 감동적이어서 꼭 보라고 추천하고 싶어요.', q:'이 사람은 영화를 어떻게 생각합니까?', o:['지루하다','감동적이다','무섭다','어렵다'], c:1, e:'“감동적이어서 추천” = cảm động nên giới thiệu.'},
      {k:'listen', a:'가: 여보세요, 지금 통화 괜찮으세요? 나: 죄송한데 회의 중이라서 이따가 전화드릴게요.', q:'여자는 왜 지금 통화할 수 없습니까?', o:['집에 없어서','회의 중이라서','전화가 고장 나서','시간이 많아서'], c:1, e:'“회의 중이라서” = vì đang họp.'},
      ...
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 열심히 준비한 ___ 시험에 합격했어요.', o:['덕분에','때문에','바람에','대신에'], c:0, e:'덕분에 = nhờ (kết quả tốt); 때문에/바람에 thường cho kết quả xấu.'},
      {k:'read', p:'도시는 편리한 반면에 공기가 나쁩니다. 그래서 요즘 시골로 이사하는 사람이 늘고 있습니다.', q:'글의 내용과 같은 것은?', o:['도시는 공기가 좋다','시골로 가는 사람이 많아진다','도시는 불편하다','시골은 복잡하다'], c:1, e:'“시골로 이사하는 사람이 늘고 있습니다” = người về quê tăng lên.'},
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 한국어는 공부하면 ___ 재미있어요.', o:['할수록','하지만','하니까','하려고'], c:0, e:'을수록 = càng… càng: càng học càng thú vị.'},
      ...
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 친구가 내일 ___ 했어요.', o:['온다고','오다고','올다고','와다고'], c:0, e:'Gián tiếp 다고 하다 với động từ hiện tại: 오다 → 온다고.'},
      {k:'read', p:'일회용품 사용을 줄이면 환경을 보호할 수 있습니다. 작은 실천이 지구를 살립니다.', q:'글쓴이가 하고 싶은 말은?', o:['일회용품을 많이 쓰자','환경을 위해 실천하자','여행을 자주 가자','돈을 아끼자'], c:1, e:'Ý chính: hãy hành động vì môi trường.'},
      {k:'read', q:'빈칸에 알맞은 것을 고르십시오: 어제 시험 공부를 ___ 잠을 못 잤어요.', o:['하느라고','하지만','하려고','하는데'], c:0, e:'느라고 = vì mải làm việc này nên không làm được việc kia.'},
      {k:'read', q:'관용 표현 ‘손이 크다’의 뜻으로 알맞은 것은?', o:['인심이 좋다','키가 크다','힘이 세다','바쁘다'], c:0, e:'“손이 크다” (nghĩa bóng) = hào phóng, rộng rãi.'},
      {k:'read', p:'가: 요즘도 매일 운동해요? 나: 네, 꾸준히 하다 보니 이제 습관이 됐어요.', q:'“나”에 대한 설명으로 알맞은 것은?', o:['운동을 그만두었다','운동이 습관이 되었다','운동을 싫어한다','가끔 운동한다'], c:1, e:'“하다 보니 습관이 됐어요” = làm mãi thành thói quen.'}
    ]
  }
];
...
function topikResult(t){
  ...
  <div class="page-head">
    ...
    <p>${pct >= 80 ? 'Tuyệt vời! 🎉' : pct >= 60 ? 'Khá tốt — cố thêm chút nữa nhé.' : 'Cần luyện thêm — xem kỹ đáp án và giải thích bên dưới.'} Thời gian đã dùng: ${used} / ${t.minutes} phút.</p>
...
function topikView(){
  ...
  if (!S || S.phase === 'intro' || !S.testId){
    ...
    <div class="page-head">
      ...
      <h1>Thi thử TOPIK</h1>
      <p>Đề <b>tự soạn theo dạng thức TOPIK</b> (không phải đề thi thật), có <b>bấm giờ</b>, chấm điểm và <b>đáp án kèm giải thích</b>. Câu Nghe phát bằng giọng đọc — bấm nút “Nghe”.</p>
    </div>
